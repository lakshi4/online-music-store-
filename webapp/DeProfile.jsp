...
<body>
	...
	<%
		...
		Bio<input type="text" name="bio" value="<%=bio%>" readonly><br>
		UserName<input type="text" name="username" value="<%=userName%>" readonly><br>
		Password<input type="text" name="passw" value="<%=password%>" readonly><br>
		
		<input type="submit" name="submit" value="Delete my Profile"><br>
		</form>
