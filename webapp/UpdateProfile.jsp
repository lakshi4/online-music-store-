...
<body>
	   ...
	   <div class= "back-image">
		...
		Artist ID<input type="text" name="artid" value="<%=id%>" readonly><br>
		Name <input type="text" name="name" value="<%=name%>" autocomplete="off"><br>
		Email<input type="text" name="email" value="<%=email%>" autocomplete="off"><br>
		Country<input type="text" name="country" value="<%=country%>" autocomplete="off"><br>
		Bio<input type="text" name="bio" value="<%=bio%>" autocomplete="off"><br>
		UserName<input type="text" name="uname" value="<%=userName%>" autocomplete="off"><br>
		Password<input type="text" name="passw" value="<%=password%>" autocomplete="off"><br>
		
		<input type="submit" name="submit" value="Update my Profile"><br>
		</form>
