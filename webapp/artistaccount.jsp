...
<body>
	...
	<div class="header-text mb-4">
		   <h1  style=text-align:center, style=font-color:#008080>My Profile</h1>
	</div>	     
	<table>
	<c:forEach var="art" items="${artDetails}">
	
		<c:set var="id" value="${art.id}"/>
		<c:set var="name" value="${art.name}"/>
		<c:set var="email" value="${art.email}"/>
		<c:set var="country" value="${art.country}"/>
		<c:set var="bio" value="${art.bio}"/>
		<c:set var="uname" value="${art.username}"/>
	...
	<c:url value="UpdateProfile.jsp" var="artupdate">
	...
	<br>
	<c:url value="DeProfile.jsp" var="artdelete">
	...
	<a href="${artdelete}">
	<input type="button" name="delete" value="Delete my Profile">
	</a>
